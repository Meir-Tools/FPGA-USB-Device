...
#if {[is_project_open]} {
#	if {[string compare $quartus(project) "DE0_Default"]} {
#		puts "Project DE0_Default is not open"
#		set make_assignments 0
#	}
#} else {
#	# Only open if not already open
#	if {[project_exists DE0_Default]} {
#		project_open -revision DE0_Default DE0_Default
#	} else {
#		project_new -revision DE0_Default DE0_Default
#	}
...
if {$make_assignments} {
	...
	set_location_assignment PIN_B1 -to led ;# LEDG[9] 
	...
	set_location_assignment PIN_H2 -to button ;# BUTTON[0]
	...
	set_location_assignment PIN_V7 -to usb_dn ;# GPIO1_D[31] ; D-
	set_location_assignment PIN_V6 -to usb_dp ;# GPIO1_D[30] ; D+
	set_location_assignment PIN_U8 -to GPIO1_D[29] 
	set_location_assignment PIN_Y7 -to usb_dp_pull ;# GPIO1_D[28] ; usb_dp_pull
	...
	set_location_assignment PIN_R12 -to uart_tx ;# GPIO1_D[23] ; uart_tx -> near the GND
